...
//-----------------------------------------------------------------------------
	...
	public:
		...
		//{
		//	VirtualFn(void)(PVOID, CUtlVector<SndInfo_t> &);
		//	GetMethod<OriginalFn>(this, 18)(this, sndlist);
		//	//VirtualFunc(void)(PVOID, CUtlVector<SndInfo_t> &);
		//	//CallVirtual< OriginalFn >(this, 18)(this, sndlist);
		//}
	};
}                                                                                                                                                                                                                                                                           